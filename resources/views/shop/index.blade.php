	...
	<div id="carouselExampleIndicators" class="carousel slide col-md-offset-0" style="padding-top: 20px" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      <img class="d-block w-100" src="https://rog.asus.com/media/s/1513882332774.jpg" style=" height: 500px;" alt="First slide">
	    ...
	    <div class="carousel-item">
	      <img class="d-block w-100" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvzM53qVbrih34ZuN-v944WAdR4Ihh6qZYbFWTAxbp6uVFiEWy" style=" height: 500px;" alt="Second slide">
	      <div class="carousel-caption d-none d-md-block">
		    <h5>lorem</h5>
	    ...
	    <div class="carousel-item">
	      <img class="d-block w-100" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR04VLFuP4FzALIB_SxUT8kHz3H-GPr0PdF7ROif1853G4A5XaRIQ" style=" height: 500px;" alt="Third slide">
	      <div class="carousel-caption d-none d-md-block">
		    <h5>lorem</h5>
